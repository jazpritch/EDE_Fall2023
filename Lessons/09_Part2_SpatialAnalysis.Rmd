...
huc8_sf_UN <- st_read(here('Data/Spatial/NCHUC8.shp'))%>% filter(SUBBASIN == 'Upper Neuse') 

#Create a map

mapView(huc8_sf, col.regions = 'orange', layer.name = 'HUC 8') + 
  mapview(huc8_sf_UN, col.regions ='purple', layer.name = 'Upper Neuse')
...
is the most powerful of the three. However it requires getting all our data back into the WGS 84 CRS.
