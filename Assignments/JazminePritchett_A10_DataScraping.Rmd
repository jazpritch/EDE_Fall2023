...
```{r fetch.and.plot.Asheville.multiyear.data,echo = TRUE, warning = FALSE, message = FALSE}
#9 
...
> Answer:
> Over time, the trend for water usage has been increasing since around 2015 after it was decreasing before then. 
